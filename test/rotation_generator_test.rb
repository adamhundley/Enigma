...
class RotationGeneratorTest < Minitest::Test
  ...
  def test_it_can_take_a_date_that_ends_with_a_zero
    kg = RotationGenerator.new("56789", "111210")

    assert_equal "111210", kg.date
  end

  def test_it_can_pass_a_key_that_ends_with_a_zero
    kg = RotationGenerator.new("56780", "111210")

    assert_equal "56780", kg.key.to_s
  end

  def test_it_can_take_a_date_that_starts_with_a_zero
    kg = RotationGenerator.new("56789", "011215")

    assert_equal "011215", kg.date.to_s
  end
